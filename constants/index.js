...
export const experiences = [
  ...
  },
  {
    ...
    contents: [
      ...
      "Integrated Artificial Intelligence (AI) models to provide automated medical recommendations and decision-making support.",
      "Designed efficient database schemas and high-performance APIs to handle real-time medical data exchange.",
      "Ensured data security and privacy in interactions between users and the AI assistant.",
    ],
  },
  {
    ...
    contents: [
      ...
      "Organized digital and physical document archiving to ensure workflow efficiency and easy data retrieval.",
      "Collaborated with the operational team to maintain customer data integrity according to applicable industry regulatory standards.",
    ],
  },
];
